...
class SExtractor:
    ...
    _SE_config = { 
        ...
        "ASSOC_PARAMS":
        {"comment": 'Nos of the columns in the ASSOC file that will be used as coordinates and weight for crossmatching.',
         "value": '1,2'},
         
         "ASSOC_NAME":
        {"comment": "Name of the ASSOC ASCII file.",
         "value": "sky.list"},
        ...
        {"comment": "Name of the ASSOC ASCII file.",
         ...
         "THRESH_TYPE":
        {"comment": "Meaning of the DETECT THRESH and ANALYSIS THRESH",
         "value": "RELATIVE"},
