...
class SExtractorfile:
    ...
    _SE_keys = \
             {"NUMBER"         : {"comment": "Running object number",
              ...
              "PETRO_RADIUS"   : {"comment": "Petrosian apertures in units of A or B",
                                  "infunc": float,
                                  "format": "%12g",
                                  "unit": ""},
              "FLUX_RADIUS"   : {"comment": "Radius enclosing a specified fraction of the flux",
                                  "infunc": float,
                                  "format": "%5.2f",
                                  "unit": ""},
              ...
              "NUMBER_ASSOC"     : {"comment": " Number of ASSOCiated IDs",
                                  "infunc": float,
                                  "format": "%5.2f",
                                  "unit": ""},
              
              "VECTOR_ASSOC"     : {"comment": "ASSOCiated parameter vector",
                                  "infunc": float,
                                  "format": "%5.2f",
                                  "unit": ""}
